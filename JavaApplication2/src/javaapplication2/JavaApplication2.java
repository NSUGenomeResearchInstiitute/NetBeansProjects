...
// ----------------------------------------------------------
StringBuffer getTextFromPDF(String file_name) throws IOException
{
...
// ----------------------------------------------------------
StringBuffer stretch(StringBuffer txt)
{   
...
// ----------------------------------------------------------
String replace(String target, String from, String to)
{   
...
// ----------------------------------------------------------
FileWriter fileOut(String file_name)
{
...
// ----------------------------------------------------------
//EasyReader fileIn(String file_name)
//{
...
// ----------------------------------------------------------
StringBuffer extractTextFromPDF(String file_name) throws IOException
{
...
// ----------------------------------------------------------
StringBuffer extractWordsFromPDF(String file_name) throws IOException
{
...
// ----------------------------------------------------------
String fixHyphenation(StringBuffer wordsBuffer)
{
...
// ----------------------------------------------------------
int indexOfReferences(String txt) throws IOException
{
...
public class JavaApplication2 {
    ...
    public static void main(String[] args) {
        // TODO code application logic here
         ...
         Pdf2text doc = new Pdf2text();
         try{
             doc.extractTextFromPDF("1.pdf");
